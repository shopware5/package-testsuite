...
echo "Run tests"
docker-compose run -eANT_OPTS=-D"file.encoding=UTF-8" tools ant -f /var/www/html/build/build.xml build-continuous -Dapp.path="" -Dapp.host="web.example" -Ddb.host="mysql.example" -Ddb.port=3306 -Ddb.name="shopware" -Ddb.user="shopware" -Ddb.password="shopware"
